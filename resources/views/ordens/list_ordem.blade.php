    ...
    <div class="row">
        <div class="col-md-10">
            <div class="form-group">
                ...
                @csrf
                    <input type="text" name="filter" placeholder="Status ordem de serviço" class="form-control" style="width: 87.00%">
    ...
    <table class="table "> 
       ...
       <tbody>  
            ...
            @foreach($ordens as $ordem)
                ...
                <td style="width: 10.00%">{{$ordem->hora}}</td>
                ...
                -->
                    ...
                    <td style="width: 10.00%"><button type="button" class="btn btn-secondary" style="background-color:grey" data-toggle="modal" data-target=".bd-modal-lg">Visualizar</button>
