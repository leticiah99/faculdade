    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <span style="font-size:16px">Cadastros </span>
          ...
          <li class="nav-item" >
            <a class="nav-link {{ request()->is('ordens*') ? 'active' : ''  }}" href="http://127.0.0.1:8000/ordens">
              <span data-feather="file"></span>
              Ordens de Serviço
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('clientes*') ? 'active' : '' }}" href="http://127.0.0.1:8000/clientes">
